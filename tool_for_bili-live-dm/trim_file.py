...
def _trim_file(in_path: str):
    with open(in_path, "r", 1048576, encoding="utf-8") as input_file, open(in_path + "_trim", "a", 1048576, "utf-8") as output_file:
        for line in input_file.readlines():
            ...
            if x["cmd"] in _SKIP_KEYWORDS:
                continue
            output_file.write(date + json.dumps(x, ensure_ascii=False, separators=(",", ":")) + "\n")
