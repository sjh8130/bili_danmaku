...
class Dm(_message.Message):
    __slots__ = ["id_str", "mode", "size", "color", "uhash", "text", "date", "weight", "rnd", "attr", "biz_scene", "bubble", "dm_type", "emoticons", "voice", "animation", "aggregation", "send_from_me", "check", "user", "room", "icon", "reply", "unknown24", "unknown25", "unknown26", "unknown27", "unknown28", "unknown29", "unknown30", "unknown31", "unknown32"]
    ...
    bubble: Bubble
    dm_type: DmType
    emoticons: _containers.RepeatedCompositeFieldContainer[emots_temp]
    voice: Voice
    animation: str
...
class emots_temp(_message.Message):
    __slots__ = ["key", "value"]
...
class User(_message.Message):
    __slots__ = ["uid", "name", "name_color", "face", "vip", "svip", "rank", "mobile_verify", "lpl_status", "attr", "medal", "level", "title", "identify", "wealth", "group_medal"]
    UID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    GROUP_MEDAL_FIELD_NUMBER: _ClassVar[int]
    uid: int
    name: str
    name_color: str
    face: str
...
class Title(_message.Message):
    __slots__ = ["title", "old_title"]
    TITLE_FIELD_NUMBER: _ClassVar[int]
    OLD_TITLE_FIELD_NUMBER: _ClassVar[int]
    title: str
    old_title: str
    def __init__(self, title: _Optional[str] = ..., old_title: _Optional[str] = ...) -> None: ...
...
class GroupMedal(_message.Message):
    __slots__ = ["medal_id", "name", "is_lighted"]
    MEDAL_ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    IS_LIGHTED_FIELD_NUMBER: _ClassVar[int]
    medal_id: int
    name: str
    is_lighted: int
    def __init__(self, medal_id: _Optional[int] = ..., name: _Optional[str] = ..., is_lighted: _Optional[int] = ...) -> None: ...
